...
# Base Path
u_id_path = "/users/<string:user_id>"
...
@app_views.route("{}".format(u_id_path), methods=["GET"], strict_slashes=False)
...
@app_views.route("{}".format(u_id_path), methods=[del_], strict_slashes=False)
...
@app_views.route("{}".format(u_id_path), methods=["PUT"], strict_slashes=False)
