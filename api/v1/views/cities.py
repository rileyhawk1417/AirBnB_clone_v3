...
# Base path
cid_path = "/cities/<string:city_id>"
scid_url = "/states/<string:state_id>/cities"


@app_views.route("{}".format(scid_url), methods=["GET"], strict_slashes=False)
...
@app_views.route("{}".format(cid_path), methods=["GET"], strict_slashes=False)
...
@app_views.route("{}".format(cid_path), methods=[del_], strict_slashes=False)
...
@app_views.route("{}".format(scid_url), methods=["POST"], strict_slashes=False)
...
@app_views.route("{}".format(cid_path), methods=["PUT"], strict_slashes=False)
