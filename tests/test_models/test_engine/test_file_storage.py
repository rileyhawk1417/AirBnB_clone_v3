...
class TestFileStorageDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_file_storage(self):
        ...
        self.assertEqual(result.total_errors, 0, errMsg)
...
test_file_storage.py"
    ...
    def test_file_storage_class_docstring(self):
        ...
        self.assertIsNot(FileStorage.__doc__, None, fsDocString)
        self.assertTrue(len(FileStorage.__doc__) >= 1, fsDocString)

    def test_fs_func_docstrings(self):
        """Test for the presence of docstrings in FileStorage methods"""
        methodStr = "method needs a docstring"
        for func in self.fs_f:
            self.assertIsNot(
                func[1].__doc__, None, "{:s} {}".format(func[0], methodStr)
            )
            self.assertTrue(
                len(func[1].__doc__) >= 1,
                "{:s} {} ".format(func[0], methodStr),
            )
